<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="BookView.aspx.cs" Inherits="Library_Management_System.BookView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <center><h3>Books Inverotry List</h3></center>
                <div class="row">
                    <div class="col-sm-12 com-md-12">
                        <asp:Panel CssClass="alert alert-success" role="alert" Visible="false" ID="Panel1" runat="server">
            ...
            <center><a href="Homepage.aspx"> << Go to Home</a><span class="clearfix"></span><br /></center>
        </div>
